...
HTMLComponents.prototype = {
  ...
  processHTML: function (html) {
    ...
    // replace prefix in attributes node
    var reTagOpen = new RegExp("<" + this.options.attrNodePrefix, "g");
    var reTagClose = new RegExp("</" + this.options.attrNodePrefix, "g");
    html = html.replace(reTagOpen, "<hc-attribute-");
    html = html.replace(reTagClose, "</hc-attribute-");
    // fix <br> bug
