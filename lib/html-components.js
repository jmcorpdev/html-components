 ...
 *
 * TODO : manage data attributes into one string
 * TODO : documentation
 * TODO : add options node attributes prefix (default : '_')
...
HTMLComponents.prototype = {
     ...
     * @param {String} pattern files mask, it follow https://github.com/isaacs/node-glob options
     */
    ...
    processFile: function (filename, srcFolder, destFolder) {
        ...
        mkdirp.sync(path.dirname(path.join(destFolder, filename)));
    ...
    processAttributes: function (node, $) {
        ...
        return this.fixAttributesObject(attr);
    },
